...
def run_linear(
    ...
    """
    return run_linear_module(d_in, d_out, weights, in_features)
...
def run_embedding(
    ...
    return run_embedding_module(vocab_size, d_model, weights, token_ids)
...
def run_multihead_self_attention(
    ...
    """
    return run_multihead_self_attention_module(d_model, num_heads, q_proj_weight, k_proj_weight, v_proj_weight,
                                               o_proj_weight,
                                               in_features)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    return run_multihead_self_attention_with_rope_module(d_model, num_heads, max_seq_len, theta, q_proj_weight,
...
def run_rmsnorm(
    ...
    """
    return run_rmsnorm_module(d_model, eps, weights, in_features)
